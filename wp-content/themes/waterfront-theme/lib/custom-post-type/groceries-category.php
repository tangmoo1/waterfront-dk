...
add_action( 'init', 'groceries_category' );
//add_action( 'after_switch_theme', 'portfolio_flush' );


function groceries_category() 
{
	register_post_type('groceries', array(
	        'labels' => array(
	            'name' => __('List shop groceries', 'general'), // Tittel  header
	            ...
	            'parent_item_colon' => '',
	            'menu_name' => 'Groceries', // main left side 
	    	),
	        'public' => true,
	        'has_archive' => true,
...
add_action( 'cmb2_admin_init', 'groceries_metaboxes' );
function groceries_metaboxes() 
{
	$prefix = 'groceries_';
	 ...
	 $cmb = new_cmb2_box( array(
        ...
        'object_types'  => array( 'groceries', ), // Post type
        'context'       => 'normal',
        'priority'      => 'high',
