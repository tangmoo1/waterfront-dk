...
add_action( 'init', 'clothes_category' );



function clothes_category() 
{
	register_post_type('clothes', array(
	        'labels' => array(
	            'name' => __('List shop clothes', 'general'), // Tittel  header
	            ...
	            'parent_item_colon' => '',
	            'menu_name' => 'Clothes', // main left side 
	    	),
	        'public' => true,
	        'has_archive' => true,
        	...
        	'taxonomies' => array('categories_brand'),
    	)
    );
}
...
add_action( 'cmb2_admin_init', 'clothes_metaboxes' );
function clothes_metaboxes() 
{
	$prefix = 'clothes_';
	 ...
	 $cmb = new_cmb2_box( array(
        ...
        'object_types'  => array( 'clothes', ), // Post type
        'context'       => 'normal',
        'priority'      => 'high',
