...
add_action( 'init', 'health_category' );
//add_action( 'after_switch_theme', 'portfolio_flush' );


function health_category() 
{
	register_post_type('health', array(
	        'labels' => array(
	            'name' => __('List shop Health', 'general'), // Tittel  header
	            ...
	            'parent_item_colon' => '',
	            'menu_name' => 'Health', // main left side 
	    	),
	        'public' => true,
	        'has_archive' => true,
...
add_action( 'cmb2_admin_init', 'health_metaboxes' );
function health_metaboxes() 
{
	$prefix = 'health_';
	 ...
	 $cmb = new_cmb2_box( array(
        ...
        'object_types'  => array( 'health', ), // Post type
        'context'       => 'normal',
        'priority'      => 'high',
