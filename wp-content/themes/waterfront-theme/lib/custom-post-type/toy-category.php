...
add_action( 'init', 'toys_category' );
//add_action( 'after_switch_theme', 'portfolio_flush' );


function toys_category() 
{
	register_post_type('toys', array(
	        'labels' => array(
	            'name' => __('List shop toys', 'general'), // Tittel  header
...
add_action( 'cmb2_admin_init', 'toys_metaboxes' );
function toys_metaboxes() 
{
	$prefix = 'toys_';
	 ...
	 $cmb = new_cmb2_box( array(
        ...
        'object_types'  => array( 'toys', ), // Post type
        'context'       => 'normal',
        'priority'      => 'high',
