...
add_action( 'init', 'decorations_category' );
//add_action( 'after_switch_theme', 'portfolio_flush' );


function decorations_category() 
{
	register_post_type('decorations', array(
	        'labels' => array(
	            'name' => __('List shop decorations', 'general'), // Tittel  header
	            ...
	            'parent_item_colon' => '',
	            'menu_name' => 'Decorations', // main left side 
	    	),
	        'public' => true,
	        'has_archive' => true,
...
add_action( 'cmb2_admin_init', 'decorations_metaboxes' );
function decorations_metaboxes() 
{
	$prefix = 'decorations_';

	 $cmb = new_cmb2_box( array(
        'id'         => $prefix.'image',
        'title'         => __( 'Description Shop', 'cmb2' ),
        'object_types'  => array( 'decorations', ), // Post type
        'context'       => 'normal',
        'priority'      => 'high',
